...
- [SubtleCrypto (digest)](https://caniuse.com/mdn-api_subtlecrypto_digest): Support NIST algorithms like [SHA3](https://github.com/w3c/webappsec-subresource-integrity/issues/11) and [streams](https://github.com/w3c/webcrypto/issues/73)
